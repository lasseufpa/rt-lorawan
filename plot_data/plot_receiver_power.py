...
plt.plot(sorted_rec_power_okumura, rec_power_cdf_okumura, lw=2, label="Okumura-Hata")
plt.plot(sorted_rec_power_cost, rec_power_cdf_okumura, lw=2, label="COST-231")
